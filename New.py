...
class VooiDC:
    ...
    def login_new_api(self, init_data):
        ...
        try:
            ...
            if response.status_code == 201:
                ...
                return {"success": False, "error": 'Status respons tak terduga'}
    ...
    def print_autotrade_info(self, data):
        ...
        self.log(f"Waktu yang tersisa: {rounded_time_left}", 'custom')
    ...
    def handle_autotrade(self):
        ...
        if autotrade_data['status'] == 'finished':
            self.log("Autotrade telah selesai. Mengklaim hadiah...", 'success')
            claim_result = self.claim_autotrade(autotrade_data['autoTradeId'])
            if claim_result:
                self.log(f"Pengklaiman autotrade berhasil. Menerima {claim_result['reward']['virtMoney']} USD {claim_result['reward']['virtPoints']} VT", 'success')
    ...
    def finish_tapping_session(self, session_id, virt_money, virt_points):
        ...
        try:
            ...
            if response.status_code in [200, 201]:
                ...
                self.log(f"Status kode tak terduga saat menyelesaikan sesi tap: {response.status_code}", 'warning')
                return None
        except Exception as e:
            self.log(f"Kesalahan saat menyelesaikan sesi tap: {str(e)}", 'error')
            return None
    ...
    def get_tasks(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                self.log(f"Status kode tak terduga saat mendapatkan tugas: {response.status_code}", 'warning')
                return None
        except Exception as e:
    ...
    def start_task(self, task_id):
        ...
        try:
            ...
            if response.status_code in [200, 201]:
                ...
                self.log(f"Status kode tak terduga saat memulai tugas: {response.status_code}", 'warning')
                return None
        except Exception as e:
    ...
    def claim_task(self, task_id):
        ...
        try:
            ...
            if response.status_code in [200, 201]:
                ...
                self.log(f"Status kode tak terduga saat mengklaim tugas: {response.status_code}", 'warning')
                return None
        except Exception as e:
